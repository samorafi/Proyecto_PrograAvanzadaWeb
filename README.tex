...
Kevin Sánchez Seas             & kasanche11           &                                  \\ \hline
...
\subsection{Diagrama de base de datos (PGF/TikZ)}

Diagrama simplificado de las principales tablas y sus relaciones:
...
\node[table] (Jugadores) {Jugadores};

\node[table, right=of Jugadores] (Partidas) {Partidas};

\node[table, below=of Partidas] (PartidaParticipantes) {PartidaParticipantes};

\node[table, below=of Jugadores] (Equipos4P) {Equipos4P};

\node[table, right=of PartidaParticipantes] (PartidasEquipos4P) {PartidasEquipos4P};

\node[table, below=of Equipos4P] (EstJug) {EstadisticasJugadores2P};

\node[table, below=of PartidasEquipos4P] (EstEq) {EstadisticasEquipos4P};

\draw[->] (PartidaParticipantes) -- (Partidas);
\draw[->] (PartidaParticipantes) -- (Jugadores);

\draw[->] (PartidasEquipos4P) -- (Partidas);
\draw[->] (PartidasEquipos4P) -- (Equipos4P);

\draw[->] (Equipos4P) -- (Jugadores);

\draw[->] (EstJug) -- (Jugadores);
\draw[->] (EstEq) -- (Equipos4P);
